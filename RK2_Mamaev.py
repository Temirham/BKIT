...
libs = [
    ...
    lib(2, 'Вторая Библиотека'), 
    lib(3, 'Третья Библиотека'),
    lib(4, 'Четвертая Библиотека'), 
    lib(5, 'Пятая Библиотека'), 
    lib(6, 'Шестая Библиотека'),
]
# CD-диски
cds = [
    CD(1, 'Amphire', 5120, 2),
...
def E2():
    ...
    # Список дисков библиотеки
        list_cd = list(filter(lambda i: i[2]==p.name, one_to_many)) 
        # Если в библиотеке есть диск
